...
class ChangeNodeBST{
	...
	public static void main(String[] args) {
		...
		obj.root = insert(root,50);
		obj.root = insert(root,30);
		obj.root = insert(root,40);
		obj.root = insert(root,20);
		obj.root = insert(root,60);
		obj.root = insert(root,70);
		obj.root = insert(root,80);
		obj.root = insert(root,90);
